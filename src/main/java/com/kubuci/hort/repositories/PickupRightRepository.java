...
public interface PickupRightRepository extends JpaRepository<PickupRight, Long> {
    @Query("""
        ...
        """)
    List<PickupRight> findAllByStudentIdsWithCollectorPerson(@Param("studentIds") List<Long> studentIds);
    ...
    @Query("""
        ...
        """)
    List<PickupRight> findAllActiveByStudentIdsWithCollectorPerson(@Param("studentIds") List<Long> studentIds,
    ...
    @Query("""
        ...
        """)
    List<PickupRight> findActiveForStudentAt(@Param("studentId") Long studentId, @Param("now") LocalDateTime now);
}
